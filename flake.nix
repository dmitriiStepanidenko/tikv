  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (
      system: let
        ...
        tikv-server = craneLib.buildPackage (individualCrateArgs
          // {
            inherit src;
            pname = "tikv-server";
            doCheck = false;
        ...
        tikv-ctl = craneLib.buildPackage (individualCrateArgs
          // {
            inherit src;
            pname = "tikv-ctl";
            doCheck = false;
            cargoExtraArgs = "${commonCargoExtraArgs} -p tikv-ctl";
          });
      in {
        packages = {
          inherit tikv-server tikv-ctl;
          # Nex mostly for debug purposes
          inherit cargoArtifacts;
